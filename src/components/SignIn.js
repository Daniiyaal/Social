...
//     } else {
//       Toast.show('Please enter a valid number to proceed', Toast.LONG);
//     }
//   };
//   render() {
//     const {phone} = this.state;
...
//             <Icon name={'mobile'} size={20} style={styles.userIcon} />
//             <TextInput
...
//               maxLength={11}
//               value={phone}
//               onChangeText={(phone) => this.onEnterNumber(phone)}
//               autoFocus={true}
//             />
//           </View>
...
//             <Text style={styles.newUserText}>Not a Member?</Text>
//             <TouchableOpacity
